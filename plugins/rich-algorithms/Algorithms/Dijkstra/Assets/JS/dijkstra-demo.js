...
function on_load( )
{
	...
	//logo_box.style.top      = 500 - logo_image_height - 10 + "px";
	//logo_box.style.left     = 500  - logo_image_width  - 10 + "px";
	...
	//document.getElementById( "demo-wrapper" ).prepend( new_graph_button );
	...
	//document.getElementById( "demo-wrapper" ).prepend( begin_reset_button );
	...
	document.getElementById( "demo-wrapper" ).appendChild( canvas );
	...
	var graph_handler  = new Graph_Handler( { 
		...
		node_location_bounds: {
			...
			x1: NODE_RADIUS * 2,
			x2: 500  - ( NODE_RADIUS * 2 ),
			y1: 80 + NODE_RADIUS,
			y2: 500 - 180 - NODE_RADIUS
	...
	function shortest_path_algorithm( parameters )
	{
		...
		document.getElementById( "demo-wrapper" ).prepend( overlay );
		
		overlay.width        = 500;
		overlay.height       = 500;
		overlay.style.width  = 500  + "px";
		overlay.style.height = 500 + "px";
